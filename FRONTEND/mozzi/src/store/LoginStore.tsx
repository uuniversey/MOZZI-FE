      ...
      const fakeResponse = {
        data: {
          data: {
            ...
            token: {
              accessToken: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIzIiwiYSI6WyJST0xFX0dVRVNUIl0sImUiOiIzMzk3ODg1MjUyIiwiZXhwIjoxNzEyMDUwNTU2fQ.-A1a8mJ1aButRIzC1tIFwODhw8kPhLgCJgXFCqhkAHk',
              refreshToken: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIzIiwiYSI6WyJST0xFX0dVRVNUIl0sImUiOiIzMzk3ODg1MjUyIiwiZXhwIjoxNzEyMDUwNTU2fQ.-A1a8mJ1aButRIzC1tIFwODhw8kPhLgCJgXFCqhkAHk',
            },
          }
        }
      };
